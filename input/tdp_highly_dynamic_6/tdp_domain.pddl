...
(:action do-low
 :parameters (?h ?h2 - hour ?t - task ?ht1 ?ht2 - hour ?b1 ?b2 - battery)
 :precondition (and
    (scheduled ?t ?ht2)
    (prec ?ht2 ?ht1)
    (current ?h)
...
(:action do-medium
 :parameters (?h ?h2 - hour ?t - task ?ht1 ?ht2 - hour ?b1 ?b2 ?b3 - battery)
 :precondition (and
    (scheduled ?t ?ht2)
    (prec ?ht2 ?ht1)
    (current ?h)
...
(:action do-high
 :parameters (?h ?h2 - hour ?t - task ?ht1 ?ht2 - hour ?b1 ?b2 ?b3 ?b4 - battery)
 :precondition (and
    (scheduled ?t ?ht2)
    (prec ?ht2 ?ht1)
    (current ?h)
...
(:action do-veryhigh
 :parameters (?h ?h2 - hour ?t - task ?ht1 ?ht2 - hour ?b1 ?b2 ?b3 ?b4 ?b5 - battery)
 :precondition (and
    (scheduled ?t ?ht2)
    (prec ?ht2 ?ht1)
    (current ?h)
